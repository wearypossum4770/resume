...
!(function (t, e) {
  "object" == typeof exports && "undefined" != typeof module
    ? (module.exports = e(require("jspdf"), require("html2canvas")))
    : "function" == typeof define && define.amd
      ? define(["jspdf", "html2canvas"], e)
      : (t.html2pdf = e(t.jsPDF, t.html2canvas));
})(this, function (t, e) {
  "use strict";
  ...
  var r =
    ...
    a = function (t, e) {
      if ("number" === o(t)) return (72 * t) / 96 / e;
      var r = {};
      ...
      t.exports = (function () {
        ...
        function h(t, e) {
          t._state === O &&
            ((t._result = e),
            (t._state = T),
            0 !== t._subscribers.length && S(d, t));
        }
        function l(t, e) {
          t._state === O && ((t._state = z), (t._result = e), S(c, t));
        }
        function f(t, e, r, n) {
        ...
        function d(t) {
          ...
          if (0 !== e.length) {
            for (
              var n = void 0, o = void 0, i = t._result, a = 0;
              a < e.length;
              a += 3
            )
              (n = e[a]), (o = e[a + r]), n ? v(r, n, o, i) : o(i);
        ...
        var I = (function () {
          ...
          return (
            (t.prototype._enumerate = function (t) {
              for (var e = 0; this._state === O && e < t.length; e++)
            ...
            (t.prototype._eachEntry = function (t, e) {
              ...
              if (u === o) {
                ...
                if (p === n && t._state !== O)
                  ...
                  var c = new r(i);
                  s(c, t, p), this._willSettleAt(c, e);
                } else
                  this._willSettleAt(
                    new r(function (e) {
                      return e(t);
            ...
            (t.prototype._settledAt = function (t, e, r) {
              var n = this.promise;
              n._state === O &&
                (this._remaining--, t === z ? l(n, r) : (this._result[e] = r)),
    ...
    c = function t(e) {
      var r = n(t.convert(p.resolve()), JSON.parse(JSON.stringify(t.template))),
        o = t.convert(p.resolve(), r);
      return (o = o.setProgress(1, t, 1, [t])), (o = o.set(e));
    };
  ((c.prototype = Object.create(p.prototype)).constructor = c),
    ...
    (c.prototype.from = function (t, e) {
      return this.then(function () {
        switch (
          ...
          case "string":
            return this.set({ src: i("div", { innerHTML: t }) });
          case "element":
    ...
    (c.prototype.toPdf = function () {
      return this.thenList([
        ...
        var e = this.prop.canvas,
          ...
          i = Math.ceil(n / o),
          a = this.prop.pageSize.inner.height,
          s = document.createElement("canvas"),
          u = s.getContext("2d");
        (s.width = e.width),
          (s.height = o),
          (this.prop.pdf = this.prop.pdf || new t(r.jsPDF));
        for (var p = 0; p < i; p++) {
          p === i - 1 &&
            n % o != 0 &&
            ((s.height = n % o),
            (a = (s.height * this.prop.pageSize.inner.width) / s.width));
          var c = s.width,
            h = s.height;
          (u.fillStyle = "white"),
            u.fillRect(0, 0, c, h),
            u.drawImage(e, 0, p * o, c, h, 0, 0, c, h),
            p && this.prop.pdf.addPage();
          var l = s.toDataURL("image/" + r.image.type, r.image.quality);
    ...
    (c.prototype.outputImg = function (t, e) {
      return this.thenList([
        function () {
    ...
    (c.prototype.setPageSize = function (e) {
      return this.then(function () {
        (e = e || t.getPageSize(this.opt.jsPDF)).hasOwnProperty("inner") ||
          ((e.inner = {
            width: e.width - this.opt.margin[1] - this.opt.margin[3],
            height: e.height - this.opt.margin[0] - this.opt.margin[2],
          }),
          (e.inner.px = {
            width: s(e.inner.width, e.k),
            height: s(e.inner.height, e.k),
          }),
    ...
    (c.prototype.thenCore = function (t, e, r) {
      r = r || p.prototype.then;
      t && (t = t.bind(this)), e && (e = e.bind(this));
      var o =
          -1 !== p.toString().indexOf("[native code]") && "Promise" === p.name
            ? this
            : c.convert(n({}, this), p.prototype),
        i = r.call(o, t, e);
      return c.convert(i, this.__proto__);
    }),
    (c.prototype.thenExternal = function (t, e) {
      return p.prototype.then.call(this, t, e);
    }),
    ...
    (c.prototype.catch = function (t) {
      t && (t = t.bind(this));
      var e = p.prototype.catch.call(this, t);
      return c.convert(e, this);
    }),
    (c.prototype.catchExternal = function (t) {
      return p.prototype.catch.call(this, t);
    }),
    ...
    (t.getPageSize = function (t, e, n) {
      if ("object" === (void 0 === t ? "undefined" : r(t))) {
        var o = t;
        (t = o.orientation), (e = o.unit || e), (n = o.format || n);
      }
      ...
      return { width: p, height: u, unit: e, k: s };
    });
  var h = { toContainer: c.prototype.toContainer };
  (c.template.opt.pagebreak = {
    mode: ["css", "legacy"],
    before: [],
    after: [],
    avoid: [],
    ...
    (c.prototype.toContainer = function () {
      return h.toContainer.call(this).then(function () {
        ...
        ["before", "after", "avoid"].forEach(function (e) {
          var r = n.avoidAll && "avoid" === e;
          (o[e] = r ? [] : [].concat(a.opt.pagebreak[e] || [])),
            o[e].length > 0 &&
              (o[e] = Array.prototype.slice.call(
                t.querySelectorAll(o[e].join(", ")),
              ));
        });
        var s = t.querySelectorAll(".html2pdf__page-break");
        s = Array.prototype.slice.call(s);
        var u = t.querySelectorAll("*");
        Array.prototype.forEach.call(u, function (t) {
          var r = {
            before: !1,
            after: n.legacy && -1 !== s.indexOf(t),
            avoid: n.avoidAll,
          };
          if (n.css) {
            var a = window.getComputedStyle(t),
              u = ["always", "page", "left", "right"];
            r = {
              before:
                r.before ||
                -1 !== u.indexOf(a.breakBefore || a.pageBreakBefore),
              after:
                r.after || -1 !== u.indexOf(a.breakAfter || a.pageBreakAfter),
              avoid:
                r.avoid ||
                -1 !==
                  ["avoid", "avoid-page"].indexOf(
                    a.breakInside || a.pageBreakInside,
                  ),
            };
          }
          Object.keys(r).forEach(function (e) {
            r[e] = r[e] || -1 !== o[e].indexOf(t);
          });
          var p = t.getBoundingClientRect();
          if (r.avoid && !r.before) {
            var c = Math.floor(p.top / e),
              h = Math.floor(p.bottom / e),
              l = Math.abs(p.bottom - p.top) / e;
            h !== c && l <= 1 && (r.before = !0);
          }
          if (r.before) {
            f = i("div", {
              style: { display: "block", height: e - (p.top % e) + "px" },
            });
            t.parentNode.insertBefore(f, t);
          }
          if (r.after) {
            var f = i("div", {
              style: { display: "block", height: e - (p.bottom % e) + "px" },
            });
  ...
  var l = [],
    f = { toContainer: c.prototype.toContainer, toPdf: c.prototype.toPdf };
  (c.prototype.toContainer = function () {
    return f.toContainer.call(this).then(function () {
      if (this.opt.enableLinks) {
        var t = this.prop.container,
          e = t.querySelectorAll("a"),
          r = a(t.getBoundingClientRect(), this.prop.pageSize.k);
        (l = []),
          Array.prototype.forEach.call(
            e,
            function (t) {
              for (var e = t.getClientRects(), n = 0; n < e.length; n++) {
                var o = a(e[n], this.prop.pageSize.k);
                (o.left -= r.left), (o.top -= r.top);
                var i = Math.floor(o.top / this.prop.pageSize.inner.height) + 1,
                  s =
                    this.opt.margin[0] +
                    (o.top % this.prop.pageSize.inner.height),
                  u = this.opt.margin[1] + o.left;
                l.push({ page: i, top: s, left: u, clientRect: o, link: t });
              }
            },
            this,
          );
    ...
    (c.prototype.toPdf = function () {
      return f.toPdf.call(this).then(function () {
        if (this.opt.enableLinks) {
